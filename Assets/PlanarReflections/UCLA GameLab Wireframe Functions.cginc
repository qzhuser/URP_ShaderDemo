...
float _LineThickness = 1;		// Thickness of the wireframe line rendering
float4 _LineColor = {1,1,1,1};	// Color of the line
float4 _LineMainTex_ST;			// For the Main Tex UV transform
sampler2D _LineMainTex;			// Texture used for the line
...
UCLAGL_v2g UCLAGL_vert(appdata_base v)
{
	...
	output.uv = TRANSFORM_TEX (v.texcoord, _LineMainTex);//v.texcoord;
